...
cat("Time to load data:", difftime(Sys.time(), load_data_start_time, "secs"), "seconds")

#---------------------------
preprocessing_start_time <- Sys.time()
cat("Preprocessing...\n")
...
cat("Time taken for preprocessing: ", difftime(Sys.time(), preprocessing_start_time, "secs"), "seconds")

#---------------------------
prep_data_start_time <- Sys.time()
cat("Preparing data...\n")
...
cat("Time to prepare data: ", difftime(Sys.time(), prep_data_start_time, "secs"), "seconds")
...
cat("Time to train model: ", difftime(Sys.time(), training_start_time, "secs"), "seconds")
...
cat("Total runtime: ", difftime(Sys.time(), start_time, "mins"), "minutes")
